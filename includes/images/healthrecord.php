...
<body>
    ...
    <form action="uploadimg.php" method="post" enctype="multipart/form-data">
        <div id="example3">
            ...
            <p></p>
            <button class="btn btn-outline-primary" type=" submit" name="submit">Upload</button><br>
    ...
    <form action="displayimg.php" method="post" enctype="multipart/form-data">
        <label>Displaying images:</label>

        <input class="btn btn-outline-primary" type="submit" name="submit2" value="Display images">
    </form>
