...
<body>
	<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-list px-2">
                    <a class="nav-link" href="../../index.phpcontact-us.php">CONTACT US</a>
                </li>
            </ul>
	...
	<?php
		...
		$query1 = $db->query("SELECT * FROM patient WHERE username='$username';");
		if ($query1->num_rows > 0) {
			$insert = $db->query("INSERT into images1 (project, username) VALUES ('$project', '$username');");
			if ($insert) {
				//header("Location: labreport.php?status=done");
				echo ("<script>window.location = 'labreport.php?status=done';</script>");
